...
export default function HRMPage() {
  ...
  return (
    ...
    >
      ...
      <section id="attendance" className="space-y-4">
        <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight">Attendance Tracking</h2>
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
          Cashiers and technicians check-in directly using a terminal PIN code or biometric integration. This creates database shift events:
        </p>
        <CodeBlock
  ...
  "check_in_time": "2026-06-07T08:00:00Z"
      ...
      <section id="leaves" className="space-y-4">
        <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight">Leaves & Approvals</h2>
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
      ...
      <section id="payroll" className="space-y-4">
        <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight">Payroll Calculations</h2>
        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
